# Show HN: boum.ai – Reputation scores for MCP servers (like npm quality scores for AI agents)
...
1. Add 3 lines to your MCP server (`npm install @boum-ai/attest`)
...
- **Browse:** https://boum.ai/explore (5,800+ servers ranked by score)
- **Try without signup:** https://boum.ai/try (API key in 10 seconds, no email)
- **Example profile:** https://boum.ai/@anthropic/search
...
- **@boum-ai/attest** — 1.38 KB gzipped client. Fire-and-forget. Never blocks your server. Never throws. HMAC-signed.
- **@boum-ai/mcp** — 7.33 KB framework we built it on. Open source. ~4% overhead vs raw SDK.
- **Badge** — SVG at `boum.ai/@owner/server/badge.svg`. Cached 5 min. Renders in GitHub READMEs.
...
```
![boum](https://boum.ai/@you/server/badge.svg)
```
...
MIT licensed. Monorepo: https://github.com/SuperstellarLLC/boum-ai
