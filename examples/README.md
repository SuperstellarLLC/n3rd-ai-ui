...
Runnable MCP servers demonstrating `@boum-ai/mcp` patterns.
...
npx @modelcontextprotocol/inspector pnpm --filter @boum-ai/example-stdio-server start

# Run the HTTP example
pnpm --filter @boum-ai/example-http-server start
